...
class M4Kernel(MyKernel):
    ...
    implementation = 'jupyter_MyM4_kernel'
    implementation_version = '1.0'
    language = 'M4'
    language_version = ''
    language_info = {'name': 'text/m4',
                     'mimetype': 'text/m4',
                     'file_extension': kernel_info['extension']}
    runfiletype='script'
    banner = "M4 kernel.\n" \
             "Uses M4, compiles in m4, and creates source code files and executables in temporary folder.\n"
    main_head = "\n\nint main(List<String> arguments){\n"
    main_foot = "\nreturn 0;\n}"
    def __init__(self, *args, **kwargs):
        super(M4Kernel, self).__init__(*args, **kwargs)
        self.runfiletype='script'
        self.kernelinfo="[MyM4Kernel{0}]".format(time.strftime("%H%M%S", time.localtime()))
